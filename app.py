...
with st.sidebar:
    ...
    manual_md = '''
**💡 기본 용어 안내**
* **평가 수익**: 아직 주식을 팔지 않아서 발생한 장부상의 수익입니다.
* **확정 수익(실현 수익)**: 주식을 실제로 팔아서 내 통장에 들어온 진짜 돈입니다.

---

**📊 대시보드 (총 자산)**  
**[ 확정 수익 + 평가 수익 ]**  
통장에 들어온 현금과 보유 중인 주식의 가치를 모두 합산하여, 회장님의 **전체 총 자산 규모**를 한눈에 파악하는 요약 화면입니다.

**✍️ 매매 기록 (현금화된 수익)**  
**[ 오직 확정 수익만 ]**  
주식을 매도하여 내 통장에 확실하게 들어온 **진짜 수익(확정 수익)**만을 따로 모아서, 달력과 상세 내역으로 꼼꼼하게 추적하는 화면입니다.
'''
