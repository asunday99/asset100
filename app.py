    ...
    for week in weeks:
        ...
        for d in week:
            if d.month == _disp_month and d in daily_pnl_dict:
                ...
                val_color     = "white"
                formatted_val = "&nbsp;"
            style_data = f"height:60px;background-color:#000000;color:{val_color};border:1px solid rgba(255, 218, 185, 0.5);text-align:center;vertical-align:middle;padding:3px;font-size:12px;font-weight:bold;"
