...
elements.forEach(el => {
    if (el.innerText.includes("목표 재설정")) {
        ...
        try:
            ...
            _svg_d1 = _make_area_svg(_monthly_last_asset, "#AA46D6", "#48cae4", lambda v: f"{v/100000000:.1f}억", 1)
            _svg_d2 = _make_area_svg(_monthly_ach, "#AA46D6", "#82b1ff", lambda v: f"{v:.1f}%", 2)
