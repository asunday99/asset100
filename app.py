...
def _render_trade_calendar(df_rec: pd.DataFrame):
    ...
    for week in weeks:
        ...
        for d in week:
            ...
            # Base Tile Styles (Pale Blue Hologram)
            base_bg = "linear-gradient(135deg, rgba(138, 180, 248, 0.1), rgba(10, 20, 40, 0.4))"
            ...
            if val > 0:
                # Trophy Style (Pale Blue Hologram + Gold)
                base_bg = "radial-gradient(circle at top left, rgba(240, 248, 255, 0.3), rgba(138, 180, 248, 0.1)), linear-gradient(135deg, rgba(138, 180, 248, 0.2), rgba(10, 20, 40, 0.6))"
                border_style = "1px solid rgba(220, 240, 255, 0.4)"
                box_shadow = "box-shadow: 0 0 15px rgba(138, 180, 248, 0.25), inset 0 0 20px rgba(138, 180, 248, 0.15);"
